...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu top">		
			...
			<li>	
				<a href="<c:url value = '/account/logout.htm' />" class="logout">
		...
		<main>
			...
			<ul class="box-info">
				...
				<li>
					...
					<span class="text">
						<h3><fmt:formatNumber type="number" pattern="##,###" value="${total_profit}" /> đ</h3>
						<p>Tổng doanh thu</p>
					</span>
				</li>
			</ul>
		 ...
		 <div class="chart">
                ...
                <div class="col-12" style="position: relative;">
                   <form action = "<c:url value ='/admin/test.htm' />" method="post" class = "form_year_select" style="position: absolute;z-index: 10000;top: 20px;right: 40px;">
