...
<link rel="stylesheet"
	href="<c:url value = '/include/css/admin/author_admin.css' />" />
...
<header class="header" id="header">
	...
	<div id="app doan">
		<div class="background_black" id="background_black">
			...
			<form action="<c:url value = '/admin/brand/delete.htm' />"
				method="post" class="confirm_container remove_class bg-white">
				<input type="hidden" id="input_id_delete" name="idbrand" value="1">
		...
		<section id="sidebar">
			<ul class="side-menu top">
				<li><a href="<c:url value = '/admin/statistics.htm' />"> <i
						class='bx bx-bar-chart-alt'></i> <span class="text">Thống
							kê</span>
				</a></li>

				<li><a href="<c:url value = '/admin/watch.htm' />"
					class="sidebar-link"> <i class='bx bxs-watch-alt'></i><span
						class="text">Sản phẩm</span>
				</a></li>

				<li class="sidebar-item"><a
					href="<c:url value = '/admin/order.htm' />" class='sidebar-link'>
						<i class='bx bxs-cart-alt'></i><span class="text">Đơn đặt
							hàng</span>
				</a></li>

				<li class="sidebar-item"><a
					href="<c:url value = '/admin/review.htm' />" class="sidebar-link">
						<i class='bx bxs-pen'></i><span class="text">Đánh giá</span>
				</a></li>
				<li class="sidebar-item"><a
					href="<c:url value = '/admin/customer.htm' />" class="sidebar-link"><i
						class='bx bxs-group'></i><span class="text">Nhân viên</span> </a></li>
				...
				<li class="sidebar-item active"><a
					href="<c:url value = '/admin/brand.htm' />" class="sidebar-link">
						<i class='bx bxs-component'></i> <span class="text">Hãng
							đồng hồ</span>
				</a></li>

				<li class="sidebar-item"><a
					href="<c:url value = '/admin/category.htm' />" class="sidebar-link">
						<i class='bx bx-dialpad-alt'></i> <span class="text">Loại
							đồng hồ</span>
				</a></li>

				<li class="sidebar-item"><a
					href="<c:url value = '/admin/publisher.htm' />"
					class="sidebar-link"> <i class='bx bxs-city'></i><span
						class="text">Nhà cung cấp</span>
				</a></li>
				<li>	
						...
						<div class="head">
							...
							<form action="" class="search" id="search-bar">
								<input type="search" name="keyword" id="keyword"
									placeholder="Type something..." class="search__input"><i class='bx bx-search'></i>
								<button type="submit">
							...
							<div style="display: flex;">
								...
								<div class="form_add display_none" style="margin-left: 20px;">
									<form action="<c:url value = '/admin/brand/add.htm' />"
						...
						<table>
							...
							<tbody>
								<c:forEach var="item" items="${brands}">
									<tr>
										<td>${item.brand_id}</td>
										<td><span class="ten_hien_thi">${item.brand_name}</span>
											<div class="form_chinh_sua display_none">
												<form action="<c:url value = '/admin/brand/edit.htm' />"
													method="post" style="display: flex;">
													<input type="hidden" name="idbrand"
														value="${item.brand_id}"> <input
														class="class_input_edit" name="brandName" type="text"
										...
										<td class="align-middle text-center">
											...
											<button type="button" class="btn btn-danger btn_delete">
												<input type="hidden" name="idbrand" value="${item.brand_id}"
													tentacgia="${item.brand_name}"> <i
													style="color: white" class="fa fa-trash-alt"></i>
											</button>
										</td>
									</tr>
								</c:forEach>
	...
	<form action="<c:url value = '/admin/brand.htm' />" id="form_page">
