              ...
              <div class="logo">
                <a href="<c:url value ='/home.htm' />" style="text-decoration: none"
                  ><img
                    ...
                    srcset=""
                  />
                  <span style="font-size: 25px">watchSTORE</span></a
                >
              </div>
            </div>
          </div>
                    ...
                    <div class="card-body px-3 py-4-5">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          <h6 class="font-extrabold mb-0"><a href="<c:url value ='/account/infoCustomer.htm' />">${user.username}</a> | <span><a href="<c:url value ='/account/logout.htm' />">Logout</a></span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                              ...
                              <form action="<c:url value ='/account/info.htm' />" method="post" id = "form_edit_info_submit">
                                ...
                                <div style="margin-bottom: 20px; display: flex">
                                  ...
                                  <div class="form-check" style="margin-right: 20px;">
                                    <input class="form-check-input" type="radio" name="gender" value = "1" <c:if test="${customer.gender == 'Nam'}">checked</c:if>/>
                                    <label class="form-check-label">Nam</label>
                                  </div>
                                  <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" value = "0" <c:if test="${customer.gender == 'Nữ'}">checked</c:if> />
