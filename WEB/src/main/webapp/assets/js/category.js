...
function ListChapProcess(e, t, a, n, o) {
    $("#list-chapter .pagination").replaceWith(n),
        ...
        window.history.pushState({ type: "list_chap", truyen_name: e, truyen_ascii: t, page: a }, "Truyện " + e + " - Trang " + a, "/" + t + "/trang-" + a + "/#list-chapter"),
        (document.title = "Truyện " + e + " - Trang " + a),
        ga("send", "pageview", { page: "/" + t + "/trang-" + a + "/", title: "Truyện " + e + " - Trang " + a + " - Ajax" });
}
function FormError(e, t) {
    t
        ? $("#" + t + " .single-page-status")
              ...
              .html(e)
        : ($(".single-page-status").removeClass("alert-success hide").addClass("alert-danger").html(e), $("html, body").animate({ scrollTop: $(".single-page-status").offset().top }, "slow"));
}
function FormSuccess(e, t) {
    t
        ? $("#" + t + " .single-page-status")
              ...
              .html(e)
        : ($(".single-page-status").removeClass("alert-danger hide").addClass("alert-success").html(e), $("html, body").animate({ scrollTop: $(".single-page-status").offset().top }, "slow"));
}
...
function UsernameValidate(e) {
    if (e.match(/^[a-z][a-z0-9]*[_\.]?[a-z0-9]+$/) && 3 <= (e = e.length) && 18 >= e) return "ok";
}
function PasswordValidate(e) {
    if (6 <= (e = e.length) && 128 >= e) return "ok";
}
...
function load_comment(e, t, a) {
    if (("light", $("#" + e).html('<div class="fb-comments" data-href="http://truyenfull.vn/' + t + '/" data-width="100%" width="100%" data-numposts="5" data-colorscheme="light"></div>'), "undefined" != typeof FB))
        FB.XFBML.parse(document.getElementById(e));
    else
        var n = setInterval(function () {
            "undefined" != typeof FB && (FB.XFBML.parse(document.getElementById(e)), clearInterval(n));
        }, 100);
}
...
$(document).ready(function () {
    if ($("body").is("#body_home")) {
        ...
        $(".index-intro .item").each(function () {
            var o = $(this),
                ...
                c = $(o).height(),
                s = $(o).offset().top;
            (o = $(o).offset().left) >= n && s >= a && o + r <= n + e && s + c <= a + t + 1 && (i.attr("src", i.attr("lazysrc")), i.attr("lazysrc", ""));
        });
    }
    $("body").is("#body_truyen") &&
        !$.browser.mobile &&
        ((function () {
            ...
            for (var a in (document.body.insertBefore(e, null), t))
            ...
            return document.body.removeChild(e), void 0 !== n && 0 < n.length && "none" !== n;
        })() ||
    ...
    var o,
        ...
        h = $("#truyen-id").val();
    if (
        ($("body").is("#body_truyen") && update_views(h, "truyen"),
        ...
        "/" != window.location.pathname &&
            ...
            o.getElementById(r) || (((o = o.createElement(i)).id = r), (o.src = "https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0&appId=1516365928790164"), c.parentNode.insertBefore(o, c)));
    ...
    if (
        ...
        $("#truyen-background").on("change", function () {
            ...
            l
                ? "hatsan" == e
                    ? ($("body").css({ "background-color": "#f2f2f2", "background-image": "url('//static.8cache.com/img/bg_op.png')", "background-repeat": "repeat" }).removeClass("dark-theme"), (u = "light"))
                    : "sachcu" == e
                    ? ($("body").css({ "background-color": "#c2b49b", "background-image": "url('//static.8cache.com/img/bg_book_op.png')", "background-repeat": "repeat" }).removeClass("dark-theme"), (u = "light"))
                    : "#232323" == e
                    ? ($("body").css({ "background-color": e, "background-image": "url('//static.8cache.com/img/bg_dark.gif')", "background-repeat": "repeat" }).addClass("dark-theme"), (u = "dark"))
                    : ($("body").css({ "background-color": e, "background-image": "none" }).removeClass("dark-theme"), (u = "light"))
                : "#232323" == e
                ? ($("body").addClass("dark-theme"), (u = "dark"))
                : ($("body").removeClass("dark-theme"), (u = "light")),
        ...
        1 == $("#chapter-sac").val() && ga("send", "event", "truyensac"),
            ...
            1 == f && ($("#fluid-no").attr("checked", !1), $("#fluid-yes").attr("checked", !0)),
            1 == v ? ($("#onebreak-no").attr("checked", !1), $("#onebreak-yes").attr("checked", !0)) : (original_content = $(".chapter-c").html()),
            ...
            $(".chapter-nav").on("click", "button.chapter_jump", function () {
                $("button.chapter_jump").attr("disabled", !0),
                    $.get("/ajax.php", { type: "chapter_option", data: h }).done(function (e) {
                        var t = "";
                        y && (t = "quyen-" + y + "-"), (e = e.replace(new RegExp(t + "chuong-" + b + '">', "g"), t + "chuong-" + b + '" selected>')), $(".chapter_jump").replaceWith(e);
                    });
            }),
            $(".chapter-nav").on("click", "button#chapter_error", function () {
                ...
                "" === e
                    ...
                    : ($("button#chapter_error").addClass("hide"), $.post("/ajax.php", { type: "chapter_error", id: $("#chapter-id").val(), message: e }), alert("Cảm ơn bạn đã báo nha."));
            }),
            $(".chapter-nav").on("click", "button#chapter_comment", function () {
                load_comment("fb-comment-chapter", d, u);
            }),
            (p = $(".truyen-title").text()),
            $.post("/ajax.php", { type: "chapter_view_history", tid: h, tenfull: p, ten: l, bnum: y, num: b, t: new Date().getTime() }),
    ...
    if (
        ($("#search-input").keyup(function () {
            ...
            clearTimeout(k),
                0 == (e = $(this).val()).length
                    ...
                    : 3 <= e.length &&
                      ($(".list-search-res").html('<img src="//static.8cache.com/img/loading-search.gif" alt="loading">').removeClass("hide"),
        ...
        $(".top-nav").on("click", "div", function () {
            ...
            e.css({ cursor: "default", "pointer-events": "none", opacity: "0.6" }),
                $.get("/ajax.php", { type: "top_switch", data_type: t, data_limit: a, data_cat: n }).done(function (t) {
                    $(".top-nav div").removeClass("active"), e.addClass("active"), e.css({ cursor: "pointer", "pointer-events": "auto", opacity: "1" }), $(".top-item").remove(), $(".top-nav").after(t), $(".top-item").hide().fadeIn(300);
                });
        }),
        ...
        $("#list-chapter").on("submit", "#page_jump", function (e) {
            ...
            n > e && (n = e),
                isNumber(n) &&
                    ...
                    $.get("/ajax.php", { type: "list_chapter", tid: h, tascii: s, tname: a, page: n, totalp: e }).done(function (e) {
                        ListChapProcess(a, s, n, e.page_list, e.chap_list), t.css({ cursor: "pointer", "pointer-events": "auto", opacity: "1" });
                    }));
        }),
        $("#list-chapter").on("click", ".pagination li a", function (e) {
            ...
            if ("javascript:void(0)" != a) {
                ...
                var n = $("h1").text();
                if (((e = $("#total-page").val()), a == "https://truyenfull.vn/" + s + "/#list-chapter")) o = 1;
                else {
                    var o = a.match(/(\d+)(?!.*\d)/);
                    o = o[1];
                }
                $.get("/ajax.php", { type: "list_chapter", tid: h, tascii: s, tname: n, page: o, totalp: e }).done(function (e) {
                    ListChapProcess(n, s, o, e.page_list, e.chap_list), t.css({ cursor: "pointer", "pointer-events": "auto", opacity: "1" });
                });
            }
        }),
        $("#body_home").length)
        ...
        var w = function () {
            $("#hot-select option:selected").next().val()
                ...
                $.get("/ajax.php", { type: "hot_select", id: id }).done(function (e) {
    ...
    if (
        ...
        $("#contact-form").submit(function (e) {
            ...
            if (!e || !a || !n) return FormError("Bạn vui lòng điền đủ thông tin liên hệ.", "contact-container"), !1;
            FormDisable(".single-page-form"),
                ...
                $.post("/ajax.php", { type: "contact", name: e, email: t, subject: a, message: n, secure: o }).done(function (e) {
                    FormEnable(".single-page-form"),
                        "success" == e.status
                            ? (FormSuccess("Bạn đã gửi nội dung liên hệ thành công! / Your message was sent successfully!", "contact-container"), $("#contact-form").trigger("reset"), $("#contact-secure").val(e.token))
                            : FormError(
                                  "Gửi nội dung liên hệ thất bại, bạn vui lòng thử lại sau hoặc gửi email trực tiếp đến contact@truyenfull.vn / Error, please try again later or send email directly to contact@truyenfull.vn",
                                  "contact-container"
                              );
                });
        }),
        $(".pagination-container").on("submit", "#page_jump", function (e) {
            ...
            e
                ? isNumber(t) && 0 == t % 1 && (window.location.href = "https://truyenfull.vn/" + e + "/" + s + a + "/trang-" + t + "/")
                : isNumber(t) && 0 == t % 1 && (window.location.href = "https://truyenfull.vn/" + s + "/trang-" + t + "/#list-chapter");
        }),
        $("#chapter-nav-top, #chapter-nav-bot").on("change", ".chapter_jump", function () {
            $("option:selected", this);
            var e = this.value;
            e && l && (window.location.href = "https://truyenfull.vn/" + l + "/" + e + "/");
        }),
        ...
        $(".rate-holder").raty({
            number: 10,
            path: "//static.8cache.com/lib/raty/images",
            ...
            click: function (e) {
                $(".rate-holder").raty("readOnly", !0), $.post("/ajax.php", { type: "rate", data: e, id: h }), localStorage.setItem(h, "rated"), alert("Cảm ơn bạn đã đánh giá truyện!");
            },
            readOnly: function () {
                if ("rated" == localStorage.getItem(h)) return !0;
            },
        }),
        randomso(1, 8),
        $("div.lazyimg").length)
            ...
            $("div.lazyimg").each(function () {
                if ($(this).is(":onScreen")) {
                    var e = $.browser.mobile ? $(this).data("image") : $(this).data("desk-image"),
                        ...
                        a = $(this).data("alt");
                    (e = t ? '<img src="' + e + '" class="' + t + '" alt="' + a + '">' : '<img src="' + e + '" alt="' + a + '">'), $(this).replaceWith(e);
                }
            });
        };
        C(),
                ...
                if (a.mobile === b) {
                    ...
                    return (h = g.findMatch(g.mobileDetectRules.tablets, c))
                        ...
                        : void (g.isMobileFallback(c)
                              ? ((i = f.isPhoneSized(d)),
                                i === b ? ((a.mobile = g.FALLBACK_MOBILE), (a.tablet = a.phone = null)) : i ? ((a.mobile = a.phone = g.FALLBACK_PHONE), (a.tablet = null)) : ((a.mobile = a.tablet = g.FALLBACK_TABLET), (a.phone = null)))
...
})(window, document, "script", "//static.8cache.com/js/analytics.js", "ga");
...
function rotate_cookie_func(rorate_pos, min, max) {
    ...
    if (rotate_val >= max) $.cookie(rorate_pos, min, { expires: 1, path: "/" });
    else $.cookie(rorate_pos, Number(rotate_val) + 1, { expires: 1, path: "/" });
    return rotate_val;
}
function load_qc_outbrain(fbadsbackup, WEB_URL, tentruyen) {
    postscribe(
        fbadsbackup,
        '<div class="OUTBRAIN" data-src="' + WEB_URL + "/" + tentruyen + "/" + '" data-widget-id="GS_1" data-ob-template="Truyenfull.vn"></div> <script type="text/javascript" async="async" src="//widgets.outbrain.com/outbrain.js"></script>'
    );
}
function backupads(fbadsbackup) {
    var WEB_URL = "https://truyenfull.vn";
    var tentruyen = $("#ten-truyen").val();
    if (!tentruyen) tentruyen = $("#truyen-ascii").val();
    $(fbadsbackup).html("");
    if (fbadsbackup == "#ads-320-100-backup-4") {
        load_qc_outbrain(fbadsbackup, WEB_URL, tentruyen);
    }
}
...
function ads_load(urlIads) {
    var WEB_URL = "https://truyenfull.vn";
    var tentruyen = $("#ten-truyen").val();
    var truyenascii = $("#truyen-ascii").val();
    var truyen_id = $("#truyen-id").val();
    var totallenght = $(".chapter-c").html().length;
    console.log(totallenght);
    var content = $(".chapter-c").find("p, br, img, table");
    var contentLength = content.length;
    var google_top_ads = parseInt((contentLength / 10) * 0.8);
    var oneAds = parseInt((contentLength / 10) * 1.5);
    var towAds = parseInt((contentLength / 10) * 2.2);
    var threeAds = parseInt((contentLength / 10) * 4);
    var adsChapterNew = parseInt((contentLength / 10) * 4.5);
    var addInpage = parseInt((contentLength / 10) * 3);
    var addInpage_13_no_ads = parseInt((contentLength / 10) * 3.4);
    var fourAds = parseInt((contentLength / 10) * 6);
    var fiveAdmicro = parseInt((contentLength / 10) * 6.2);
    var fiveSAds = parseInt((contentLength / 10) * 5.5);
    var fiveAds = parseInt((contentLength / 10) * 8);
    var inpageAdmicro = parseInt((contentLength / 10) * 7.2);
    var sevenAdsShoppe = parseInt((contentLength / 10) * 7.5);
    var inpageShopee3 = parseInt((contentLength / 10) * 7);
    var adsDetailTruyen = parseInt((contentLength / 10) * 9);
    var not_show_ads = $("#not_show_ads").val();
    if (!not_show_ads) not_show_ads = 0;
    var arrayD = [
        15447,
        27589,
        28237,
    ...
    console.log(Number(truyen_id));
    var truyenDcma = 0;
    if (jQuery.inArray(Number(truyen_id), arrayD) > -1) {
        truyenDcma = 1;
    }
    console.log(truyenDcma);
    var ds = new Date(),
        hour_ads = ds.getHours();
    if (not_show_ads == 0 || !$.browser.mobile) {
        var s2 = document.createElement("script");
        s2.setAttribute("id", "arf-core-js");
        s2.async = true;
        s2.onerror = function () {
            window.arferrorload = true;
        };
        s2.src = "//ght.kernh41.com/tf/commons.min.js";
        $("head").append(s2);
    } else {
        if (truyenDcma == 1) {
            var s2 = document.createElement("script");
    ...
    if ($.browser.mobile) {
        content.eq(google_top_ads).after('<div class="ads-mobile" id="ads-chapter-google-top" style="margin-bottom: 10px; margin-top: 10px" align="center"></div>');
        if (not_show_ads == 0) {
            postscribe(
                "#ads-chapter-google-top",
                '<div class="ads-chapter-box"><div class="ads-top"><span class="txt-ads">Advertisements</span></div><div class="ads-content"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3829250631432207" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3829250631432207" data-ad-slot="2327960496" data-ad-format="auto" data-full-width-responsive="true"></ins><script>(adsbygoogle=window.adsbygoogle||[]).push({});</script></div></div>'
            );
        } else {
            load_qc_outbrain("#ads-chapter-google-top", WEB_URL, tentruyen);
        }
    } else {
        content.eq(google_top_ads).after('<div class="ads-mobile" id="ads-chapter-google-top" style="margin-bottom: 10px; margin-top: 10px" align="center"></div>');
        if (not_show_ads == 0) {
            postscribe(
                "#ads-chapter-google-top",
                '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3829250631432207" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3829250631432207" data-ad-slot="2327960496" data-ad-format="auto" data-full-width-responsive="true"></ins><script>(adsbygoogle=window.adsbygoogle||[]).push({});</script>'
            );
        } else {
            load_qc_outbrain("#ads-chapter-google-top", WEB_URL, tentruyen);
        }
    ...
    if ($.browser.mobile) {
        if (not_show_ads == 0) {
            content.eq(oneAds).after('<div class="ads-responsive ads-mobile" id="ads-chapter-top" align="center"></div>');
        }
    } else {
        if (totallenght >= 2500) {
            content.eq(oneAds).after('<div style="display: flex"><div class="ads-network ads-desktop" id="ads-chapter-top" style="padding-top:0;"></div></div>');
            postscribe("#ads-chapter-top", '<div id="iads-6005635436846b6a1f08cf62" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/6005635436846b6a1f08cf62.js" async></script>');
            nextNode_remove("ads-chapter-top");
        }
    }
    if ($.browser.mobile) {
        if ($("#ads-chapter-google-bottom").length > 0) {
            postscribe("#ads-chapter-google-bottom", '<div class="ads-iads" id="iads-6371e4fa47ca0421da7febe3"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/6371e4fa47ca0421da7febe3.js"></script>');
        }
    } else {
        if ($("#ads-chapter-google-bottom").length > 0) {
            if (not_show_ads == 0) {
                postscribe(
                    "#ads-chapter-google-bottom",
                    '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3829250631432207" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3829250631432207" data-ad-slot="9060055657" data-ad-format="auto" data-full-width-responsive="true"></ins><script>(adsbygoogle=window.adsbygoogle||[]).push({});</script>'
                );
            } else {
                postscribe("#ads-chapter-google-bottom", '<div class="ads-iads" id="iads-6371e5621b19dd543b5c1913"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/6371e5621b19dd543b5c1913.js"></script>');
            }
        }
    }
    if (totallenght >= 1500) {
        if (!$.browser.mobile) {
            if (totallenght >= 3000) {
                content.eq(towAds).after('<div class="ads-network ads-desktop" id="ads-chapter-longtop" style=""></div>');
                postscribe("#ads-chapter-longtop", '<div id="iads-600563490f20f20db26fadc2" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/600563490f20f20db26fadc2.js" async></script>');
            }
        } else {
            content.eq(towAds).after('<div class="ads-responsive ads-mobile" id="ads-chapter-longtop"></div>');
            postscribe("#ads-chapter-longtop", '<div id="iads-600259627ab7962bf4647bc2" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/600259627ab7962bf4647bc2.js" async></script>');
        }
        if ($.browser.mobile) {
            if (not_show_ads == 0) {
                content
                    .eq(addInpage)
                    .after(
                        '<div class="ads-chapter-box"><div class="ads-top"><span class="txt-ads">Advertisements</span></div><div class="ads-content"><div id="ads-inpage-container"><div class="tpads_in_page"><div class="tpads_in_page_wrapper"><div class="tpads_in_page_wrapper-content" id="ads-inpage-content"></div></div></div></div></div></div>'
                    );
                postscribe(
                    "#ads-inpage-content",
                    '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3829250631432207" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:inline-block;width:300px;height:600px" data-ad-client="ca-pub-3829250631432207" data-ad-slot="6904801659"></ins><script>(adsbygoogle=window.adsbygoogle||[]).push({});</script>'
                );
            } else {
                content
                    .eq(addInpage_13_no_ads)
                    .after(
                        '<div class="ads-chapter-box-1"><div class="ads-content"><div id="ads-inpage-container"><div class="tpads_in_page"><div class="tpads_in_page_wrapper"><div class="tpads_in_page_wrapper-content" id="ads-inpage-content-13shopee" style="text-align: -webkit-center;"></div></div></div></div></div></div>'
                    );
                postscribe("#ads-inpage-content-13shopee", '<div class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/63841217e64e670f95185cb3.js"></script>');
            }
        }
        if (!$.browser.mobile) {
            content.eq(threeAds).after('<div class="ads-network ads-desktop" id="ads-chapter-middle" style=""></div>');
            if (not_show_ads == 0) {
                postscribe(
                    "#ads-chapter-middle",
                    '<div class="ads-chapter-box"><div class="ads-top"><span class="txt-ads">Advertisements</span></div><div class="ads-content"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3829250631432207" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3829250631432207" data-ad-slot="6345663334" data-ad-format="auto" data-full-width-responsive="true"></ins><script>(adsbygoogle=window.adsbygoogle||[]).push({});</script></div></div>'
                );
            }
        } else {
            content.eq(threeAds).after('<div class="ads-responsive ads-mobile" id="ads-chapter-middle" style="padding-top:0"></div>');
            if (not_show_ads == 0) {
                postscribe(
                    "#ads-chapter-middle",
                    '<div class="ads-chapter-box"><div class="ads-top"><span class="txt-ads">Advertisements</span></div><div class="ads-content"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3829250631432207" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3829250631432207" data-ad-slot="6345663334" data-ad-format="auto" data-full-width-responsive="true"></ins><script>(adsbygoogle=window.adsbygoogle||[]).push({});</script></div></div>'
                ...
                var mdInPage = new MobileDetect(window.navigator.userAgent);
                var mOsIn = mdInPage.os(),
                    isMobileIn = mdInPage.mobile();
                if (isMobileIn) {
                    if (mOsIn == "iOS" || mOsIn == "iPadOS") {
                    } else {
                        if (jQuery.inArray(navigator.platform, ["Win32", "Win64", "iPad", "iPhone"]) == -1) {
                            if (totallenght >= 3000) {
                                content.eq(adsChapterNew).after('<div class="ads-responsive ads-mobile" id="ads-chapter-news-1"></div>');
                                postscribe("#ads-chapter-news-1", '<div class="ads-iads" id="iads-5fbe062130b16d3648366592"></div><script async src="https://iads.staticscdn.net/iadsc/5/f/5fbe062130b16d3648366592.js"></script>');
                                if ($("#ads-lien-quan-5").length > 0) {
                                    postscribe("#ads-lien-quan-5", '<div class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/5/f/5ff2e0673e917d31032f5da2.js"></script>');
                                }
                            }
                        }
                    }
        ...
        if ($.browser.mobile) {
            content.eq(fiveAdmicro).after('<div class="ads-responsive ads-mobile" id="ads-middle-admicro"></div>');
            if (not_show_ads == 0) {
            } else {
                if (truyenDcma == 1) {
                    if (totallenght >= 10000) {
                        content.eq(inpageShopee3).after('<div class="ads-responsive ads-mobile" id="ads-middle-shoppe-3"></div>');
                        postscribe("#ads-middle-shoppe-3", '<div id="iads-602defd3222700684260c1b2" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/602defd3222700684260c1b2.js" async></script>');
                    } else {
                        postscribe("#ads-middle-admicro", '<div id="iads-602defd3222700684260c1b2" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/602defd3222700684260c1b2.js" async></script>');
                    }
                } else {
                    postscribe("#ads-middle-admicro", '<div id="iads-602defd3222700684260c1b2" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/602defd3222700684260c1b2.js" async></script>');
                }
            ...
            content.eq(fiveAdmicro).after('<div class="ads-responsive" id="ads-chapter-video-outstream-zmedia"></div>');
            if (not_show_ads == 0) {
                postscribe("#ads-chapter-video-outstream-zmedia", '<zone id="l942555u"></zone><script>arfAsync.push("l942555u");</script>');
            }
        }
        if ($.browser.mobile) {
            content.eq(fourAds).after('<div class="ads-responsive ads-mobile" id="ads-chapter-news-2"></div>');
        } else {
        }
        if ($.browser.mobile) {
            if (totallenght >= 3000) {
                content.eq(fiveAds).after('<div class="ads-responsive ads-mobile" id="ads-chapter-five"></div>');
                if (not_show_ads == 0) {
                    if (totallenght >= 5000) {
                        postscribe(
                            "#ads-chapter-five",
                            '<div class="ads-chapter-box"><div class="ads-top"><span class="txt-ads">Advertisements</span></div><div class="ads-content"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3829250631432207" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3829250631432207" data-ad-slot="3098873888" data-ad-format="auto" data-full-width-responsive="true"></ins><script>(adsbygoogle=window.adsbygoogle||[]).push({});</script></div></div>'
                        );
                    }
                } else {
                    content.eq(fiveAds).after('<div class="ads-responsive ads-mobile" id="ads-chapter-news-3"></div>');
                }
            }
        }
        if ($.browser.mobile) {
            ...
            var mOs = md.os(),
                isMobile = md.mobile();
            if (isMobile) {
                if (mOs == "iOS" || mOs == "iPadOS") {
                } else {
                    if (jQuery.inArray(navigator.platform, ["Win32", "Win64", "iPad", "iPhone"]) == -1) {
                        if (totallenght >= 3000) {
                            content.eq(fiveSAds).after('<div class="ads-responsive ads-mobile" id="ads-chapter-news"></div>');
                            postscribe("#ads-chapter-news", '<div class="ads-iads" id="iads-60055eb087df8849712b7272"></div><script async src="https://iads.staticscdn.net/iadsc/6/0/60055eb087df8849712b7272.js"></script>');
                        }
                    }
                }
            }
            ...
            if (not_show_ads == 0) {
                if (totallenght >= 2000) {
                    content
                        .eq(inpageAdmicro)
                        .after(
                            '<div class="ads-chapter-box"><div class="ads-top"><span class="txt-ads">Advertisements</span></div><div class="ads-content"><div id="ads-inpage-container-admicro"><div class="tpads_in_page"><div class="tpads_in_page_wrapper"><div class="tpads_in_page_wrapper-content" id="ads-inpage-content-23google" style="text-align: -webkit-center;"></div></div></div></div></div></div>'
                        );
                    postscribe(
                        "#ads-inpage-content-23google",
                        '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3829250631432207" crossorigin="anonymous"></script><ins class="adsbygoogle" style="display:inline-block;width:300px;height:600px" data-ad-client="ca-pub-3829250631432207" data-ad-slot="3698782912"></ins><script>(adsbygoogle=window.adsbygoogle||[]).push({});</script>'
                    );
                }
            } else {
                if (totallenght >= 2000) {
                    content
                        .eq(inpageAdmicro)
                        .after(
                            '<div class="ads-chapter-box"><div class="ads-top"><span class="txt-ads">Advertisements</span></div><div class="ads-content"><div id="ads-inpage-container-admicro"><div class="tpads_in_page_admicro"><div class="tpads_in_page_wrapper_admicro"><div class="tpads_in_page_wrapper-content_admicro" id="ads-inpage-content-admicro" style="text-align: -webkit-center;"></div></div></div></div></div></div>'
                        );
                    postscribe("#ads-inpage-content-admicro", '<div class="ads-iads" id="iads-635f262b2e1aab3a4e25ae43"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/635f262b2e1aab3a4e25ae43.js"></script>');
                }
            }
        }
        if (totallenght >= 5000) {
            if ($.browser.mobile) {
                content.eq(adsDetailTruyen).after('<div class="ads-responsive ads-mobile" id="ads-chapter-detail-truyen"></div>');
            } else {
                content.eq(adsDetailTruyen).after('<div class="ads-responsive ads-mobile" id="ads-chapter-detail-truyen"></div>');
            }
        }
    ...
    if (!$.browser.mobile) {
        if (not_show_ads == 0) {
            if ($("#balloon-ads").length > 0) {
                postscribe("#balloon-ads", '<div id="zone-balloon-ads-desktop"><zone id="l5hoip67"></zone><script>arfAsync.push("l5hoip67");</script></div>');
            }
        } else {
            if (truyenDcma == 1) {
                if ($("#balloon-ads").length > 0) {
    ...
    if ($.browser.mobile) {
        if (totallenght >= 5000) {
            content.eq(sevenAdsShoppe).after('<div class="ads-responsive ads-mobile" id="ads-chapter-nettruyenfull" align="center"></div>');
            postscribe("#ads-chapter-nettruyenfull", '<div class="ads-iads" id="iads-6413bfb4e3bbd60a2f69cf93"></div><script async src="https://iads.staticscdn.net/iadsc/6/4/6413bfb4e3bbd60a2f69cf93.js"></script>');
        }
    } else {
        content.eq(sevenAdsShoppe).after('<div class="ads-responsive ads-mobile" id="ads-chapter-nettruyenfull" align="center"></div>');
        postscribe("#ads-chapter-nettruyenfull", '<div class="ads-iads" id="iads-6413bfe875e96236201d7a53"></div><script async src="https://iads.staticscdn.net/iadsc/6/4/6413bfe875e96236201d7a53.js"></script>');
    }
}
$(document).ready(function () {
    var WEB_URL = "https://truyenfull.vn";
    var tentruyen = $("#ten-truyen").val();
    var truyenascii = $("#truyen-ascii").val();
    var isHomePage = $("#intro-index").length;
    const arrDomainDev = ["st.truyenfull.vn"];
    var urlIads = "//iads.staticscdn.net";
    var htmlHome =
        '<div id="link-icon"><div class="link-icon-list"><div class="link-icon-item"> <a target="_blank" href="https://cv.timviec.com.vn"> <img src="/static/img/icon/tim_viec.png"><p>CV Tìm Việc</p> </a></div><div class="link-icon-item"> <a target="_blank" href="https://timviec.com.vn/viec-lam-hap-dan"> <img src="/static/img/icon/viec_lam_hap_dan.png"><p>Việc Làm Hấp Dẫn</p> </a></div><div class="link-icon-item"> <a target="_blank" href="https://webtintuc.com/sao"> <img src="/static/img/icon/tin_tuc_sao.png"><p>Tin Tức Sao</p> </a></div><div class="link-icon-item"> <a target="_blank" href="https://webtintuc.com/the-gioi"> <img src="/static/img/icon/tin_the_gioi.png"><p>Tin Thế Giới</p> </a></div><div class="link-icon-item"> <a target="_blank" href="https://timviec.com.vn/viec-lam-hot"> <img src="/static/img/icon/viec_lam_hot.png"><p>Việc Làm HOT</p> </a></div><div class="link-icon-item"> <a target="_blank" href="https://timviec.com.vn/viec-lam-luong-cao"> <img src="/static/img/icon/viec_lam_luong_cao.png"><p>Việc Làm Lương Cao</p> </a></div><div class="link-icon-item"> <a target="_blank" href="https://webtintuc.com/tin-tuc"> <img src="/static/img/icon/tin_xa_hoi.png"><p>Tin Xã Hội</p> </a></div><div class="link-icon-item"> <a target="_blank" href="https://webtintuc.com/khoa-hoc-kham-pha"> <img src="/static/img/icon/101_dieu_thu_vi.png"><p>1001 Điều Thú Vị</p> </a></div></div></div>';
    var htmlHomeDesktop =
        '<div id="link-icon"><div class="link-icon-list"><div class="link-icon-item"><a target="_blank" href="https://cv.timviec.com.vn"><img src="/static/img/icon/tim_viec.png"><p>CV Tìm Việc</p></a></div><div class="link-icon-item"><a target="_blank" href="https://timviec.com.vn/viec-lam-hap-dan"><img src="/static/img/icon/viec_lam_hap_dan.png"><p>Việc Làm Hấp Dẫn</p></a></div><div class="link-icon-item"><a target="_blank" href="https://timviec.com.vn/viec-lam-hot"><img src="/static/img/icon/viec_lam_hot.png"><p>Việc Làm HOT</p></a></div><div class="link-icon-item"><a target="_blank" href="https://timviec.com.vn/viec-lam-luong-cao"><img src="/static/img/icon/viec_lam_luong_cao.png"><p>Việc Làm Lương Cao</p></a></div><div class="link-icon-item"><a target="_blank" href="https://webtintuc.com/sao"><img src="/static/img/icon/tin_tuc_sao.png"><p>Tin Tức Sao</p></a></div><div class="link-icon-item"><a target="_blank" href="https://webtintuc.com/the-gioi"><img src="/static/img/icon/tin_the_gioi.png"><p>Tin Thế Giới</p></a></div><div class="link-icon-item"><a target="_blank" href="https://webtintuc.com/tin-tuc"><img src="/static/img/icon/tin_xa_hoi.png"><p>Tin Xã Hội</p></a></div><div class="link-icon-item"><a target="_blank" href="https://webtintuc.com/khoa-hoc-kham-pha"><img src="/static/img/icon/101_dieu_thu_vi.png"><p>1001 Điều Thú Vị</p></a></div></div></div>';
    var objListImage = {
        1: {
            link: "https://cv.timviec.com.vn/?utm_source=truyenfull&utm_campaign=banner_top",
            link_image: "https://iads.staticscdn.net/ads/2021/06/23/images/otfu6mWu9qGvkKXtH0BtuSGFVVHrZQ54ACNEWRy1.jpg",
            alt: "Tạo cv miễn phí - tăng cơ hội tuyển dụng",
        },
        2: {
            link: "https://timviec.com.vn/?utm_source=truyenfull&utm_campaign=banner_desktop_truyenfull",
            link_image: "https://iads.staticscdn.net/ads/2021/03/24/images/4zUU3LCQYPvLYKsHFuqirdHxBpkgxEmtDPFAbayD.jpg",
            alt: "Hàng ngàn công việc đang chờ đợi bạn",
        },
    };
    var objListImageMobile = {
        1: {
            link: "https://cv.timviec.com.vn/?utm_source=truyenfull&utm_campaign=banner_mobile_truyenfull",
            link_image: "https://iads.staticscdn.net/ads/2021/05/13/images/Q3CF7EJKgqHA8hK9DUTdAXkzFxrwvMtuXkakEDLE.png",
            alt: "Tạo cv miễn phí - tăng cơ hội tuyển dụng",
        },
        2: {
            link: "https://timviec.com.vn/?utm_source=truyenfull&utm_campaign=banner_mobile_truyenfull",
            link_image: "https://iads.staticscdn.net/ads/2021/06/24/images/V8uRgowFpbCoiurCRHqj00pHCVcYhZcpywTtWY7m.jpg",
            alt: "Hàng ngàn công việc đang chờ đợi bạn",
        },
    };
    var keyShow = randomso(1, 2);
    var dataBanner = objListImage[keyShow];
    var dataBannerMobile = objListImageMobile[keyShow];
    var dataContentImage =
        '<div class="iads-img" style="width: 100%; display: block;overflow: hidden;position: relative;margin-top: -10px;margin-bottom: 10px;"><a href="' +
        dataBanner.link +
        '" class="iads-link-ads" rel="nofollow" target="_blank"><img style="width: 100%;" src="' +
        dataBanner.link_image +
        '" title="' +
        dataBanner.alt +
        '" alt="' +
        dataBanner.alt +
        '"></a></div>';
    var dataContentImageMobile =
        '<div class="iads-img" style="width: 100%; display: block;overflow: hidden;position: relative;margin-top: -10px;margin-bottom: 10px;"><a href="' +
        dataBannerMobile.link +
        '" class="iads-link-ads" rel="nofollow"  target="_blank"><img style="width: 100%;" src="' +
        dataBannerMobile.link_image +
        '" title="' +
        dataBannerMobile.alt +
        '" alt="' +
        dataBannerMobile.alt +
        '"></a></div>';
    if (!$.browser.mobile) {
        if ($("#the-loai-right-banner").length > 0) {
            postscribe("#the-loai-right-banner", '<div id="iads-60079fb8f7e36e44f56eee72" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/60079fb8f7e36e44f56eee72.js" async></script>');
        }
        if ($("#the-loai-right-banner-bottom").length > 0) {
            postscribe("#the-loai-right-banner-bottom", '<div id="iads-600e49bf6c5fd81e9e5fc8d2" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/600e49bf6c5fd81e9e5fc8d2.js" async></script>');
        }
        if ($("#ads-300x250-detail-truyen-top").length > 0) {
            postscribe("#ads-300x250-detail-truyen-top", '<div id="iads-60079fef8b2a35225f55b172" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/60079fef8b2a35225f55b172.js" async></script>');
        }
        if ($("#ads-detail-truyen-main-middle").length > 0) {
            postscribe("#ads-detail-truyen-main-middle", '<div id="iads-6007a088de3cd747c43f8643" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/6007a088de3cd747c43f8643.js" async></script>');
        }
        if ($("#ads-300x250-detail-truyen-bottom").length > 0) {
            postscribe("#ads-300x250-detail-truyen-bottom", '<div id="iads-6007a053ea12c63b5a11f022" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/6007a053ea12c63b5a11f022.js" async></script>');
        }
        if ($("#intro-index").length) {
            if ($("#banner_image_home").length > 0) {
                postscribe("#banner_image_home", '<div id="iads-628c809923be9b000a135cd3" class="ads-iads"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/2/628c809923be9b000a135cd3.js" async></script>');
            }
        }
        if ($(".ads-chapter-bottom-lien-quan").length > 0) {
            if ($("#is_show_slide").length == 0) {
                var widthTruyen = document.getElementById("ads-chapter-bottom-lien-quan").offsetWidth;
                $("#ads-lien-quan-1").html(
                    '<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div style="background-color:#fff;padding: 10px;"><div class="custom-head-ads">Truyện Mới</div><div id="ads-chapter-bottom-lienquan-1" style="display: flex"></div></div></div>'
                );
                createIframe("https://iads.vision/banner_auto_generated/truyenfull_2_pc_1.html?dataid=1", widthTruyen + "px", null, "#ads-chapter-bottom-lienquan-1", 1);
                $("#ads-lien-quan-3").html(
                    '<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div style="background-color:#fff;padding: 10px;"><div class="custom-head-ads">Truyện HOT</div><div id="ads-chapter-bottom-lienquan-3" style="display: flex"></div></div></div>'
                );
                createIframe("https://iads.vision/banner_auto_generated/truyenfull_2_pc_2.html?dataid=3", widthTruyen + "px", null, "#ads-chapter-bottom-lienquan-3", 3);
            }
            $("#ads-lien-quan-2").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div id="ads-chapter-bottom-lienquan-2" style="background-color:#fff;padding: 10px;"></div></div>');
            postscribe("#ads-chapter-bottom-lienquan-2", '<div class="ads-iads" id="iads-63622687fd7c555df6051084"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/63622687fd7c555df6051084.js"></script>');
            $("#ads-lien-quan-4").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div id="ads-chapter-bottom-lienquan-4" style="background-color:#fff;padding: 10px;"></div></div>');
            postscribe("#ads-chapter-bottom-lienquan-4", ' <div class="ads-iads" id="iads-6362292d9c553356775ee0d3"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/6362292d9c553356775ee0d3.js"></script>');
            $("#ads-lien-quan-6").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div id="ads-chapter-bottom-lienquan-6" style="background-color:#fff;padding: 10px;"></div></div>');
            postscribe("#ads-chapter-bottom-lienquan-6", ' <div class="ads-iads" id="iads-63622be58ebaa610b50a05b3"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/63622be58ebaa610b50a05b3.js"></script>');
        }
    } else {
        if ($("#intro-index").length || $("#truyen").length) {
            var s3 = document.createElement("script");
            s3.setAttribute("id", "arf-core-js");
            s3.async = true;
            s3.onerror = function () {
                window.arferrorload = true;
            };
            s3.src = "//ght.kernh41.com/tf/commons.min.js";
            $("head").append(s3);
        }
        if ($("#list-page").length) {
            $("#ads-cate-list-1").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-mobile"><div id="ads-cate-list-right-1" style="background-color: #e6e6e6;"></div></div>');
            postscribe("#ads-cate-list-right-1", '<div class="ads-iads"></div><script async src="' + urlIads + '/iadsc/6/1/6149a632c8905d38094a5042.js"></script>');
        }
        if ($("#truyen").length) {
            if ($("#ads-detail-admincro").length) {
                postscribe("#ads-detail-admincro", '<zone id="l5homuag"></zone><script>arfAsync.push("l5homuag");</script>');
            }
        }
        if ($("#list-index").length) {
            if ($("#banner-bio-link").length > 0) {
                postscribe("#banner-bio-link", '<div class="ads-iads" id="iads-63bbeb608afa7d190035bd33"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/63bbeb608afa7d190035bd33.js"></script>');
            }
            if ($("#banner_image_home").length > 0) {
                postscribe("#banner_image_home", '<zone id="l5homuag"></zone><script>arfAsync.push("l5homuag");</script>');
            }
        }
        if ($("#ads-detail-truyen-main-middle").length > 0) {
            postscribe("#ads-detail-truyen-main-middle", '<div class="ads-iads" id="6361d01c2a786d72cf73cb14"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/6361d01c2a786d72cf73cb14.js"></script>');
        }
        if ($("#ads-detail-truyen-main-middle-new").length > 0) {
            var md = new MobileDetect(window.navigator.userAgent);
            var mOs = md.os(),
                isMobile = md.mobile();
            if (isMobile) {
                if (mOs == "iOS" || mOs == "iPadOS") {
                    ...
                    if (jQuery.inArray(navigator.platform, ["Win32", "Win64", "iPad", "iPhone"]) == -1) {
                        postscribe("#ads-detail-truyen-main-middle-new", '<div id="iads-60055e281ea1e91668260c92" class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/6/0/60055e281ea1e91668260c92.js"></script>');
                        postscribe("#ads-detail-truyen-main-middle-new-js", '<div id="iads-600e7ccea9a074699e7f6102" class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/6/0/600e7ccea9a074699e7f6102.js"></script>');
                    }
                }
            }
        }
        if ($("#the-loai-show-ads").length > 0) {
            var mdL = new MobileDetect(window.navigator.userAgent);
            var mOsL = mdL.os(),
                isMobileL = mdL.mobile();
            if (isMobileL) {
                if (mOsL == "iOS" || mOsL == "iPadOS") {
                } else {
                    if (jQuery.inArray(navigator.platform, ["Win32", "Win64", "iPad", "iPhone"]) == -1) {
                        postscribe("#the-loai-show-ads", '<div id="iads-5fe937c9f11ec2293d31ec62" class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/5/f/5fe937c9f11ec2293d31ec62.js"></script>');
                    }
                }
            }
        }
        if ($(".ads-chapter-bottom-lien-quan").length > 0) {
            if ($("#is_show_slide").length == 0) {
                var widthTruyen = document.getElementById("ads-chapter-bottom-lien-quan").offsetWidth;
                $("#ads-lien-quan-1").html(
                    '<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div style="background-color:#fff;padding: 6px;"><div class="custom-head-ads">Truyện Mới</div><div id="ads-chapter-bottom-lienquan-1" style="display: flex"></div></div></div>'
                );
                createIframe("https://iads.vision/banner_auto_generated/truyenfull_2_mb_1.html?dataid=1", widthTruyen + "px", null, "#ads-chapter-bottom-lienquan-1", 1);
                $("#ads-lien-quan-3").html(
                    '<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div style="background-color:#fff;padding: 6px;"><div class="custom-head-ads">Truyện HOT</div><div id="ads-chapter-bottom-lienquan-3" style="display: flex"></div></div></div>'
                );
                createIframe("https://iads.vision/banner_auto_generated/truyenfull_2_mb_2.html?dataid=2", widthTruyen + "px", null, "#ads-chapter-bottom-lienquan-3", 2);
            }
            $("#ads-lien-quan-2").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-mobile"><div id="ads-chapter-bottom-lienquan-2" style="background-color:  #fff;padding: 5px;"></div></div>');
            postscribe("#ads-chapter-bottom-lienquan-2", '<div id="iads-6363304a42307f2fdd5a1ab3" class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/6363304a42307f2fdd5a1ab3.js"></script>');
            $("#ads-lien-quan-4").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-mobile"><div id="ads-chapter-bottom-lienquan-4" style="background-color:  #fff;padding: 5px;"></div></div>');
            postscribe("#ads-chapter-bottom-lienquan-4", '<div class="ads-iads" id="iads-636330752e3b6142432039e3"></div><script async src="https://iads.staticscdn.net/iadsc/6/3/636330752e3b6142432039e3.js"></script>');
        }
    }
    if (tentruyen) {
        var not_show_ads_special = $("#not_show_ads").val();
        if (!not_show_ads_special) not_show_ads_special = 0;
        if ($.browser.mobile) {
            ads_load(urlIads);
            $("#chapter-end-bot").before('<div class="text-center ads-holder ads-taboola"><div id="ads-chapter-bottom"></div></div>');
            if (not_show_ads_special == 0) {
                load_qc_outbrain("#ads-chapter-bottom", WEB_URL, tentruyen);
            }
            if ($("#ads-timviec-list").length > 0) {
                postscribe("#ads-timviec-list", '<div class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/6/2/62e895e7d86a621a815d2fb3.js"></script>');
            }
        } else {
            ads_load(urlIads);
            $("#chapter-end-bot").before('<div class="text-center ads-holder ads-taboola"><div id="ads-chapter-bottom"></div></div>');
    ...
    if ($("#chapter-c").length > 0) {
        var objListFlyAdsShoppe = [
            { link: "https://eyep.blog/7dJqwV9R", link_image: "/static/img/shopee/sieu_code_200k.png" },
            { link: "https://eyep.blog/GtGLx0IA", link_image: "/static/img/shopee/code300k.png" },
            { link: "https://eyep.blog/Gg9RJLOO", link_image: "/static/img/shopee/code_60.png" },
        ];
        var keyShow = randomso(0, 2);
        var showFlyIcon = 0;
        var dataFlayAds = objListFlyAdsShoppe[keyShow];
        var docAdsFly = document.body || document.documentElement;
        var flayAds = document.createElement("div");
        flayAds.id = "shoppe_ads_fly";
        flayAds.className = "shoppe_ads_fly";
        flayAds.style.display = "none";
        flayAds.innerHTML =
            '<span class="bx_close_btn_new"></span><div class="fly-icon-shopee"><div><a href="' +
            dataFlayAds.link +
            '" class="bx_wrapper_downegg-sp a-click-shopee" target="_blank"><img width="100" src="' +
            dataFlayAds.link_image +
            '"></a></div></div>';
        docAdsFly.appendChild(flayAds);
        document.querySelector(".bx_close_btn_new").addEventListener("click", function () {
            flayAds.style.display = "none";
            showFlyIcon = 1;
        });
        document.querySelector(".a-click-shopee").addEventListener("click", function () {
            flayAds.style.display = "none";
            showFlyIcon = 1;
        });
        window.onscroll = function (e) {
            if (showFlyIcon == 0) {
                showFlyIcon = 1;
                setTimeout(function () {
                    flayAds.style.display = "block";
                }, 6000);
            }
        };
    }
    window.addEventListener("message", function (event) {
        if (event.origin && event.origin.includes("iads.vision") && event.data.height) {
            $("iframe[data-id=" + event.data.dataid + "]").css("height", event.data.height + "px");
        }
    });
});
