...
$(document).ready(function () {
    ...
    if (
        ...
        $("#list-chapter").on("click", ".pagination li a", function (e) {
            ...
            if ("javascript:void(0)" != a) {
                ...
                var n = $("h1").text();
                if (((e = $("#total-page").val()), a == "/" + s + "/#list-chapter")) o = 1;
                else {
                    var o = a.match(/(\d+)(?!.*\d)/);
                    o = o[1];
                }
    ...
    if (
        ...
        $(".pagination-container").on("submit", "#page_jump", function (e) {
            ...
            e ? isNumber(t) && 0 == t % 1 && (window.location.href = "/" + e + "/" + s + a + "/trang-" + t + "/") : isNumber(t) && 0 == t % 1 && (window.location.href = "/" + s + "/trang-" + t + "/#list-chapter");
        }),
        $("#chapter-nav-top, #chapter-nav-bot").on("change", ".chapter_jump", function () {
            $("option:selected", this);
            var e = this.value;
            e && l && (window.location.href = "/" + l + "/" + e + "/");
        }),
