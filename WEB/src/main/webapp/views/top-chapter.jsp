					...
					<c:forEach var="item" items="${stories }">
						<div class="row" itemscope itemtype="https://schema.org/Book">
							...
							<div class="col-xs-3" style="width: 182px; height: 82px;">
								<div>
									<img src="/assets/img/${item.getStory_picture()}"
										class="cover"
							...
							<div class="col-xs-7">
								<div>
									...
									<h3 class="truyen-title" itemprop="name">
										<a
											href="/${item.getStory_code()}/${item.getSlug() }"
											title="${item.getStory_name() }" itemprop="url">${item.getStory_name() }</a>
									</h3>
							...
							<div class="col-xs-2 text-info">
								...
								<div>
									<a
										href="/detail-story/${item.getStory_code() }/${item.getSlug() }/chuong-1"
										title="${item.getStory_name() }"> <span
										class="chapter-text"><span>Chương </span></span>${item.getTotal_chapter()}</a>
								</div>
